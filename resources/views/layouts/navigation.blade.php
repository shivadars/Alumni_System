<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 sticky top-0 z-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <!-- Navigation Links -->
            <div class="hidden space-x-2 sm:-my-px sm:flex items-center justify-center flex-1">
                @php
            ...
            <!-- Settings Dropdown -->
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-4 w-1/4 justify-end">
