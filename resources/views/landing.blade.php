...
<body class="antialiased landing-body">
    ...
    <header x-data="{ scrolled: false, mobileMenuOpen: false }" @scroll.window="scrolled = (window.pageYOffset > 20)"
        ...
        <div class="flex items-center justify-between px-6 py-3 w-full max-w-5xl rounded-full border transition-all duration-500"
            ...
            <div class="relative hidden md:block">
                ...
                <nav class="flex items-center gap-1 mx-auto border border-gray-200/50 bg-white/50 backdrop-blur-sm rounded-full p-1 shadow-sm absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-max"
                    ...
                    <a href="#features"
                        class="px-5 py-2 rounded-full text-sm font-semibold text-gray-700 hover:text-blue-600 hover:bg-blue-50/80 transition-all">Features</a>
                    <a href="#testimonials"
                        class="px-5 py-2 rounded-full text-sm font-semibold text-gray-700 hover:text-blue-600 hover:bg-blue-50/80 transition-all">Testimonials</a>
                    <a href="#footer"
                        class="px-5 py-2 rounded-full text-sm font-semibold text-gray-700 hover:text-blue-600 hover:bg-blue-50/80 transition-all">Network</a>
                </nav>

                <!-- Nav shown at top -->
                <nav class="flex items-center gap-8 mx-auto" x-show="!scrolled" x-transition.opacity.duration.300ms>
                    <a href="#features"
                        class="text-sm font-semibold text-gray-900 hover:opacity-70 transition-opacity">Features</a>
                    <a href="#testimonials"
                        class="text-sm font-semibold text-gray-900 hover:opacity-70 transition-opacity">Testimonials</a>
                    <a href="#footer"
                        class="text-sm font-semibold text-gray-900 hover:opacity-70 transition-opacity">Network</a>
                </nav>
            </div>
            ...
            <div class="hidden md:flex items-center gap-4 relative z-20">
                <a href="{{ route('login') }}"
                    class="text-sm font-semibold text-gray-700 hover:text-gray-900 transition-colors">Log in</a>
                <a href="{{ route('register') }}"
                    class="px-5 py-2.5 bg-gray-900 hover:bg-black text-white text-sm font-semibold rounded-full shadow-lg shadow-gray-900/20 hover:shadow-gray-900/40 hover:-translate-y-0.5 transition-all duration-300 whitespace-nowrap"
                    style="color: white !important;">Join Network</a>
            </div>

            <!-- Mobile Menu Toggle -->
            <button @click="mobileMenuOpen = !mobileMenuOpen"
                class="md:hidden relative z-20 p-2 text-gray-600 hover:text-gray-900 focus:outline-none">
                ...
                <svg x-show="mobileMenuOpen" style="display:none;" xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-300 transform"
            ...
            <a href="#testimonials" @click="mobileMenuOpen = false"
                class="text-lg font-semibold text-gray-900">Testimonials</a>
            ...
            <a href="{{ route('register') }}"
                class="w-full text-center py-3 bg-gray-900 text-white rounded-xl font-bold mt-2">Join Network</a>
        </div>
    </header>
    ...
    <main>
        ...
        <div class="parallax-container">
            <div class="parallax-sticky">
                ...
                <div class="parallax-image-wrapper hero-layer-2">
                    <div>
                        <img src="{{ asset('images/landing/hero_6.png') }}" alt="Left Placeholder"
        ...
        <section class="py-24 bg-white flex flex-col items-center border-t border-gray-200" id="features">
            <div class="text-center mb-16 px-4">
                <h2 class="text-3xl md:text-5xl font-semibold mb-4 text-gray-900 tracking-tight">Networking, perfected.
                </h2>
                <p class="text-lg text-gray-500 font-medium max-w-2xl mx-auto">Connect with the people who define the
                    industry. From campus mentors to global founders.</p>
            </div>

            <div
                class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto px-4 w-full justify-items-center">

                <x-flipping-card title="Direct Mentorship"
                ...
                <x-flipping-card title="Inner Circle Access"
                ...
                <x-flipping-card title="Global Reach"
        ...
        <section class="section testimonials-section" id="testimonials" x-data="circularTestimonials"
                            ...
                            <div class="quote-wrapper">
                                ...
                                <p class="quote">
                                    <template x-for="(word, wIndex) in item.quote.split(' ')" :key="wIndex">
                                        <span class="animated-word" :style="`animation-delay: ${wIndex * 0.025}s`"
                                            x-html="word + '&amp;nbsp;'"></span>
                                    </template>
                                </p>
                            </div>
