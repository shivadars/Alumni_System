                        ...
                        <div class="flex items-center gap-8">
                            ...
                            <div class="flex-shrink-0">
                                @if($alumnus->profile && $alumnus->profile->profile_picture)
                                    <img src="{{ $alumnus->profile->getProfilePictureUrl() }}" alt="{{ $alumnus->name }}" class="w-20 h-20 rounded-full object-cover ring-4 ring-slate-50 shadow-sm transition-transform duration-300 group-hover:scale-105">
                                @else
                            ...
                            <div>
                                <div class="flex items-center gap-3 mb-1">
                                    <h3 class="text-2xl font-black text-slate-900 group-hover:text-blue-600 transition-colors">{{ $alumnus->name }}</h3>
                                    @if($alumnus->profile && $alumnus->profile->linkedin_url)
                                        <a href="{{ $alumnus->profile->linkedin_url }}" target="_blank" class="text-[#0077b5] hover:scale-110 transition-transform">
